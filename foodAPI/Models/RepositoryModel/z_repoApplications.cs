...
//	}
	...
	public void SetDefaultApplication()
	{
		  AppService.AppName = "";
			...
			AppService.AdminName = "";
			AppService.ShopName = "";
			AppService.EncryptionMode = true;
			AppService.PowerBy = "";
			AppService.LanguageNo = "";
			AppService.WebSiteUrl = "";
			AppService.MailSenderName = "";
			AppService.MailSenderEmail = "";
			AppService.MailAppPassword = "";
			AppService.MailHostUrl = "";
			AppService.MailHostPort = 0;
			AppService.MailUseSSL = false;
		}
	#endregion
}